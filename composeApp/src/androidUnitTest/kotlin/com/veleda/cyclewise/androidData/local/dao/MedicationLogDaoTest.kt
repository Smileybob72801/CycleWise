...
class MedicationLogDaoTest : KoinTest {
    ...
    // --- Test Data ---
    private val parentEntry1 = DailyEntryEntity("entry-1", LocalDate(2025, 1, 5), 5, customTags = "[]", createdAt = TestData.INSTANT, updatedAt = TestData.INSTANT)
    private val parentEntry2 = DailyEntryEntity("entry-2", LocalDate(2025, 1, 6), 6, customTags = "[]", createdAt = TestData.INSTANT, updatedAt = TestData.INSTANT)
    private val parentMed1 = MedicationEntity("med-1", "Ibuprofen", TestData.INSTANT)
    private val parentMed2 = MedicationEntity("med-2", "Aspirin", TestData.INSTANT)

    private val log1_med1_entry1 = MedicationLogEntity("log-1", "entry-1", "med-1", TestData.INSTANT)
    private val log2_med2_entry1 = MedicationLogEntity("log-2", "entry-1", "med-2", TestData.INSTANT)
    private val log3_med1_entry2 = MedicationLogEntity("log-3", "entry-2", "med-1", TestData.INSTANT)
